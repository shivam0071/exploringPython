...
str3 = '<i><a href="/wiki/Kismet_(1943_film)" title="Kismet (1943 film)">Kismet</a>' \
       '</i>,directed by <b><a href="/wiki/Gyan_Mukherjee" title="Gyan Mukherjee">Gyan Mukherjee</a></b>, ran at the <a href="/wiki/Roxy_Cinema_(Kolkata)" title="Roxy Cinema (Kolkata)">Roxy, Kolkata</a>, for 3 years and 8 months?</li>'

import re
# co1 = re.compile(r'<a href="(.*?)".*>(.*)</a>')
# co2 = re.compile(r'[^<]*<a href="([^"]+)".*?>(?:[^<]<\w+>)*([^<]*?)(?:<\/\w+>)*<\/a>')
co2 = re.compile(r'[^<]*<a href="([^*])')
print(co2.findall(str3))
# def show(i):
#   for items in i:
#     print ('{0},{1}'.format(items[0],items[1]))
#
# show(co2.findall(str3))
# print(co1.findall(str3))
# print(co1.findall(str1)

# print(co1.findall(str2))

# output - http://www.quackit.com/html/tutorial/html_links.cfm,Example Link
